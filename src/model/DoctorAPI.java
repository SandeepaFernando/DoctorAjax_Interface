...
public class DoctorAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = doctor.addDoctor(
				...
				request.getParameter("dspecialty"), 
				request.getParameter("dmobile"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = doctor.updateDoctor(
				paras.get("did").toString(), 
				paras.get("dname").toString(),
				paras.get("daddress").toString(),
				paras.get("dspecialty").toString(), 
				paras.get("dmobile").toString());
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		String output = doctor.deleteDoctor(paras.get("did").toString());
